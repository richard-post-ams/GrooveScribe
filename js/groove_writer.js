...
function GrooveWriter() {
	...
	function createMidiUrlFromClickableUI(MIDI_type) {
		...
		switch (class_permutation_type) {
			...
			default:
				...
				console.log('[MIDI] writing measure ' + ab_start + ' to MIDI track (0-based)');
	...
	root.addMeasureButtonClick = function (event) {
		...
		if(class_number_of_measures === 16)
			window.alert("Heads up: you are building a long groove (16+ measures).\n" +
						"GrooveScribe now supports up to 32 measures. Performance may slow on older devices as more measures are added.");
	};
